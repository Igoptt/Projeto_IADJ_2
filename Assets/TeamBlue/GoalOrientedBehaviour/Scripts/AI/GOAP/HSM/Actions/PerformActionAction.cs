...
namespace Assets.TeamBlue.GoalOrientedBehaviour.Scripts.AI.GOAP.HSM.Actions
{
    /// <summary>
    ...
    public class PerformActionAction : IAction
    {
        ...
        /// <summary>
        /// The data provider of the <see cref="TeamRed.GoalOrientedBehaviour.Scripts.AI.GOAP.GoapAgent"/>
        /// </summary>
