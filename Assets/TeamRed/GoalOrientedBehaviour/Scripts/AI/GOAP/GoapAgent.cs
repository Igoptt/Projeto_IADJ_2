...
using Assets.TeamRed.GoalOrientedBehaviour.Scripts.AI.GOAP.HSM.Actions;
using Assets.TeamRed.GoalOrientedBehaviour.Scripts.AI.GOAP.HSM.Conditions;
using UnityEngine;

namespace Assets.TeamRed.GoalOrientedBehaviour.Scripts.AI.GOAP
{
    /// <summary>
